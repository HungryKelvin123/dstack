...
This reference is the one runtime contract for every dstack skill and playbook. Workflow files state their domain steps. This file owns how Codex performs those steps.
