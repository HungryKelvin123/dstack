---
name: technical-writing-dstack
description: "Layered technical-writing standard: Diátaxis structure, Google developer style sentences, STE instruction rules, Global English syntax. Use for $technical-writing-dstack or when writing or reviewing docs, RFCs, readmes, PR descriptions, or commit messages."
---
...
Don't invent jargon. Use the words a developer would say out loud: "move", "delete", "a budget that only decreases", not "evacuate", "ratchet", or "endgame". A named pattern is fine when the doc says what it means the first time. Add new offenders to `unslop-dstack`'s abstract-metaphor rule with their replacement.
...
- Apply the **unslop-dstack** skill to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
