---
name: show-me-your-work-dstack
description: "Keep a reviewable decision trail for long-running or unattended work: a TSV log with one row per decision (what, why, evidence, result). Local by default; commit it when a reviewer needs the trail to trust the result. Use for $show-me-your-work-dstack, autonomous or multi-phase runs, or work a human reviews after stepping away."
---
...
Write each entry the way you'd tell a teammate what you did. Plain words, concrete actions, no AI speak or abstract jargon (the **unslop-dstack** skill applies to log text too). A reviewer should understand each row without decoding it.
