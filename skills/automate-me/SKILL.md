...
Delegation and optional capabilities follow `../david-mode/references/codex-agent-runtime.md`.
...
The **david-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as david-mode's.
...
- The **david-mode** skill: example of the output shape.
