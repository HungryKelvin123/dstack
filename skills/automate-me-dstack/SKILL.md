---
name: automate-me-dstack
description: "Use for \"automate me\", \"create/update/refresh my -mode skill\", \"turn/capture my preferences or working style into a skill\", or wanting agents to follow how the user works. Drafts or revises a personal -mode skill through skill-creator and unslop, optionally using supported recent task history."
---

# Automate me

Delegation and optional capabilities follow `../david-mode-dstack/references/codex-agent-runtime.md`.

A guided flow for turning the user's working conventions into a skill agents will follow. The output is one `-mode` skill tailored to them (e.g. `jay-mode`, `priya-mode`).

This skill orchestrates three others: an inline mining pass (see step 1), the `skill-creator` skill (authoring), and the **unslop-dstack** skill (prose discipline). It sequences them; it doesn't replace them.
...
The **david-mode-dstack** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as david-mode's.
...
Apply the **unslop-dstack** skill and `skill-creator`'s writing guidelines to every line. Both apply to any agent-read prose, not just skills.
...
- The **david-mode-dstack** skill: example of the output shape.
- The **unslop-dstack** skill: prose discipline for every line.
